...
async function prediction(type, typeid) {
    // 🔹 Bypassing balance check (Even if balance is 0, prediction will work)
    console.log("Bypassing balance check. Prediction enabled for all users.");
    ...
    // Continue with prediction logic (No balance restriction)
